...
SELECT 'az-ag-007', 'ilaria.rossi@gestoreagenti.local', 'Ilaria Rossi', '$2a$10$O30tgOlPZ7UfAq5Jovg1JeNw2N5YI6TcEF/8ZbhvACyMfmB34lTgS',
       (SELECT id FROM "roles" WHERE name = 'Agent'), (SELECT id FROM "teams" WHERE name = 'Vendite'), 1
WHERE NOT EXISTS (SELECT 1 FROM "users" WHERE email = 'ilaria.rossi@gestoreagenti.local');

INSERT INTO "users" (azure_id, email, display_name, password_hash, role_id, team_id, active)
SELECT 'az-ag-008', 'davide.greco@gestoreagenti.local', 'Davide Greco', '$2a$10$O30tgOlPZ7UfAq5Jovg1JeNw2N5YI6TcEF/8ZbhvACyMfmB34lTgS',
       (SELECT id FROM "roles" WHERE name = 'Agent'), (SELECT id FROM "teams" WHERE name = 'Enterprise'), 1
WHERE NOT EXISTS (SELECT 1 FROM "users" WHERE email = 'davide.greco@gestoreagenti.local');

INSERT INTO "users" (azure_id, email, display_name, password_hash, role_id, team_id, active)
SELECT 'az-ag-009', 'chiara.pagliani@gestoreagenti.local', 'Chiara Pagliani', '$2a$10$O30tgOlPZ7UfAq5Jovg1JeNw2N5YI6TcEF/8ZbhvACyMfmB34lTgS',
       (SELECT id FROM "roles" WHERE name = 'Agent'), (SELECT id FROM "teams" WHERE name = 'Partner Channel'), 1
WHERE NOT EXISTS (SELECT 1 FROM "users" WHERE email = 'chiara.pagliani@gestoreagenti.local');

INSERT INTO "users" (azure_id, email, display_name, password_hash, role_id, team_id, active)
SELECT 'az-ag-010', 'riccardo.moretti@gestoreagenti.local', 'Riccardo Moretti', '$2a$10$O30tgOlPZ7UfAq5Jovg1JeNw2N5YI6TcEF/8ZbhvACyMfmB34lTgS',
       (SELECT id FROM "roles" WHERE name = 'Agent'), (SELECT id FROM "teams" WHERE name = 'Vendite'), 1
WHERE NOT EXISTS (SELECT 1 FROM "users" WHERE email = 'riccardo.moretti@gestoreagenti.local');

INSERT INTO "users" (azure_id, email, display_name, password_hash, role_id, team_id, active)
SELECT 'az-ag-011', 'alessandra.costa@gestoreagenti.local', 'Alessandra Costa', '$2a$10$O30tgOlPZ7UfAq5Jovg1JeNw2N5YI6TcEF/8ZbhvACyMfmB34lTgS',
       (SELECT id FROM "roles" WHERE name = 'Agent'), (SELECT id FROM "teams" WHERE name = 'Enterprise'), 1
WHERE NOT EXISTS (SELECT 1 FROM "users" WHERE email = 'alessandra.costa@gestoreagenti.local');
