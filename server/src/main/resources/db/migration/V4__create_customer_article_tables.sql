...
CREATE UNIQUE INDEX IF NOT EXISTS uq_customers_vat_number
    ON customers (vat_number);

CREATE UNIQUE INDEX IF NOT EXISTS uq_customers_tax_code
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_articles_code
    ON articles (code);
...
CREATE TABLE IF NOT EXISTS invoice_lines (
    ...
    CONSTRAINT fk_invoice_lines_article
