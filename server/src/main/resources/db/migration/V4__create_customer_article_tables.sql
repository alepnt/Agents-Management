...
CREATE UNIQUE INDEX IF NOT EXISTS uq_customers_vat_number ON customers (vat_number);
CREATE UNIQUE INDEX IF NOT EXISTS uq_customers_tax_code ON customers (tax_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_articles_code ON articles (code);

ALTER TABLE invoices
    ADD COLUMN IF NOT EXISTS customer_id BIGINT;
ALTER TABLE invoices
    ADD CONSTRAINT IF NOT EXISTS fk_invoices_customer FOREIGN KEY (customer_id) REFERENCES customers (id);
